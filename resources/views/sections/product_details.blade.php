                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__pic__item">
                                    {{-- <img src="{{asset('malefashion-master/img/shop-details/product-big-2.png')}}" alt=""> --}}
                                    @foreach ($mainProducts as $product)
                                        <img src="{{asset('malefashion-master/img/product/' . $product->image_source )}}" alt="">
                                    @endforeach
                            ...
                            <div class="tab-pane" id="tabs-2" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="{{asset('malefashion-master/img/shop-details/product-big-3.png')}}" alt="">
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-3" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="{{asset('malefashion-master/img/shop-details/product-big.png')}}" alt="">
                                </div>
                            </div>
                            <div class="tab-pane" id="tabs-4" role="tabpanel">
                                <div class="product__details__pic__item">
                                    <img src="{{asset('malefashion-master/img/shop-details/product-big-4.png')}}" alt="">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            @foreach ($mainProducts as $product)
                                <h3>${{$product->price}}<span>{{$product->price + 20.24}}</span></h3>
                            ...
                            <div class="product__details__last__option">
                                ...
                                <img src="{{asset('malefashion-master/img/shop-details/details-payment.png')}}" alt="">
                                <ul>
